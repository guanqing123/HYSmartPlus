...
#import "SPServiceViewController.h"

#import <WebKit/WebKit.h>
// 加密
#import "DES3EncryptUtil.h"

@interface SPServiceViewController ()<WKUIDelegate, WKNavigationDelegate>
...
@implementation SPServiceViewController
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    NSString *dest = [NSString stringWithFormat:@"http://kms.sge.cn?mobile=%@", [[DES3EncryptUtil encrypt:@"HYSDG"] stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet characterSetWithCharactersInString:@"'();:@&=+$,/?%#[]"].invertedSet]];
    [self.webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:dest]]];
}
...
//    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"30"] style:UIBarButtonItemStyleDone target:self action:@selector(back)];
    ...
    self.navigationItem.rightBarButtonItems = @[close, refresh];
}
