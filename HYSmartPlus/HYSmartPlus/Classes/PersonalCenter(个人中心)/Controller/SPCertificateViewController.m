//
//  SPCertificateViewController.m
//  HYSmartPlus
//
//  Created by information on 2021/3/24.
...
@interface SPCertificateViewController () <WKUIDelegate, WKNavigationDelegate>
// webView
...
@implementation SPCertificateViewController
...
- (void)setWebView {
    ...
    [webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://wx.hongyancloud.com/hyaj/gauthentic/gauthentic.html?uid=%@",[SPAccountTool loginResult].userbase.uid]]]];
...
- (void)goBack {
    !_certificateVcBlock ? : _certificateVcBlock();
    [self.navigationController popViewControllerAnimated:YES];
}
