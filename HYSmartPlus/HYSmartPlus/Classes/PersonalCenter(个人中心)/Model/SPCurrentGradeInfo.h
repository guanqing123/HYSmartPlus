...
@property (nonatomic, assign) NSNumber *currentIntegral;
//类型：Number  必有字段  备注：等级值
@property (nonatomic, assign) NSNumber *grade;
@property (nonatomic, assign) NSNumber *gradeId;
...
@property (nonatomic, assign) NSNumber *totalExpense;
//类型：Number  必有字段  备注：总积分
@property (nonatomic, assign) NSNumber *totalIntegral;
//类型：String  必有字段  备注：用户ID
@property (nonatomic, copy) NSString *userid;
//类型：Number  必有字段  备注：等级系数
@property (nonatomic, assign) NSNumber *weighing;
@end
